...
ForgeUI is developed by [RTechAI](https://github.com/RTechAI). This repository records an earlier ForgeUI generation: it was created during the ESP32-P4 UI Studio / ForgeUI One era and is preserved as a public ESP32-P4/LVGL reference.
...
It is a historical reference project, not current [ForgeUI Hosted Studio](https://studio.forgeui.co.nz) source and not represented as output generated by today's Hosted Studio.
...
ForgeUI development has since expanded through [ForgeUI](https://forgeui.co.nz) and [ForgeUI Hosted Studio](https://studio.forgeui.co.nz). ForgeUI Studio is the current visual embedded UI/HMI development environment for supported ESP32 hardware.
...
[ForgeUI](https://forgeui.co.nz) is developed by [RTechAI](https://github.com/RTechAI). RTechAI hosts ForgeUI public repositories, hardware references, and related open development work. [ForgeUI Hosted Studio](https://studio.forgeui.co.nz) is the web-based continuation of current ForgeUI Studio development.
